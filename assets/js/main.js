  ...
  init: function () {
    ...
    $("#submit").click(function () {
      ...
      if ($(".contact-form .required").size() > 0) {
        ...
        alertify.log(msg2);
        var data = {
          service_id: "service_1hap2p8",
          template_id: "template_e57z0rw", // keys from email.js
          user_id: "moGQBLUTNPghgPd7_", // keys from email.js
          template_params: {
...
function initMap() {
  ...
  var lat = 6.836624004360074;
  var lon = 79.8852271775067;
